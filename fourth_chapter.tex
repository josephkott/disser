...
\addcontentsline{toc}{chapter}{Chapter 4 \quad Localized Solutions of Nonlinear Harmonic Oscillator with Periodic Pseudopotential}
\label{chapter:IV}

\section*{4.1 Objectives}
\addcontentsline{toc}{section}{4.1 \quad Objectives}
...
As we say it in Chapter~3 stability of solutions is a critically important property.
...
\subsection*{4.1.1 Solutions with linear counterpart}
...
\addcontentsline{toc}{section}{4.2 \quad Small-Amplitude Localized Solutions with Linear Counterpart}
...
\addcontentsline{toc}{section}{4.3 \quad Branches of Nonlinear Localized Solutions for Periodic Pseudopotential, $P(x) = P_0 + P_1 \cos (\Omega x)$}
...
\subsection*{4.3.1 Periodic pseudopotential with Non-Zero Mean, $|P_0| \gtrsim |P_1|$}
...
\section*{4.4 Summary}
\addcontentsline{toc}{section}{4.4 \quad Summary}
