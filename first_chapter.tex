...
\addcontentsline{toc}{chapter}{Chapter 1 \quad Statements on Regular and Singular Solutions for Stationary States Equation $u_{xx} + Q(x) u + P(x) u^3 = 0$}
\label{chapter:I}

\section*{1.1 Objectives}
\addcontentsline{toc}{section}{1.1 \quad Objectives}
...
\section*{1.2 Non-existence of Singular Solutions: $P(x) \ge P_0 > 0$}
\addcontentsline{toc}{section}{1.2 \quad Non-existence of Singular Solutions: $P(x) \ge P_0 > 0$}
...
\addcontentsline{toc}{section}{1.3 \quad Asymptotic Behaviour at a Collapse Point: $P(x_0) < 0$}
...
\addcontentsline{toc}{section}{1.4 \quad All Solutions Are Singular: $P(x) \le P_0 < 0$, $Q(x) \le Q_0 < 0$}
...
\section*{1.5 Summary}
\addcontentsline{toc}{section}{1.5 \quad Summary}
...
\begin{table}[h!]
	...
	\begin{tabular}{ | p{4cm} | l || p{10cm} | }
		...
		We describe this method and its application in Chapter~2. %\ref{chapter:II}.
		 \\
		\hline
	\end{tabular}
	\caption{
