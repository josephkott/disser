...
\begin{frame}
	...
	\begin{block}{$\Sigma: \mathcal{O} \to \Omega^N$}
		Можно определить соответствие ($\Sigma$) между {\it орбитами} регулярных решений ($\mathcal{O}$) и {\it последовательностями} над алфавитом из $N$ символов ($\Omega^N$), где каждый символ соответствует компоненте связности множества $\mathscr{U}_L$.
	\end{block}
\end{frame}
