...
\addcontentsline{toc}{chapter}{Chapter 2 \quad Classification of Stationary States by Means of Symbolic Dynamics}
\label{chapter:II}

\section*{2.1 Objectives}
\addcontentsline{toc}{section}{2.1 \quad Objectives}
...
\addcontentsline{toc}{section}{2.2 \quad Geometry of the Poincar\'e Map}

First of all let's introduce several definitions.

\subsection*{2.2.1 Poincar\'e Map}
...
\addcontentsline{toc}{section}{2.3 \quad Poincar\'e Map Domains for Piecewise Periodic Pseudopotential}
...
Exact solutions are given in Appendix~B. % \ref{appendix:solutions-of-duffing-equations}
\begin{figure}[h]
\centering
...
\begin{proof}
	...
	% \ref{appendix:solutions-of-duffing-equations}
...
\subsection*{2.3.2 Construction of the Poincar\'e Map Domains}
...
\addcontentsline{toc}{section}{2.4 \quad Symbolic Dynamics: Coding of Solutions}
...
\addcontentsline{toc}{section}{2.5 \quad Numerical Test of Existence of Coding Homeomorphism}
...
\label{thm:h-strips-mapping}
	...
	\end{itemize}
\end{theorem}
Proof of Theorem~\ref{thm:h-strips-mapping} can be found in Appendix~C. % \ref{appendix:strips-mapping-theorems}
...
\addcontentsline{toc}{section}{2.6 \quad Stationary Solutions of GPE with Piecewise Pseudopotential}
...
\pagebreak
\section*{2.7 Summary}
\addcontentsline{toc}{section}{2.7 \quad Summary}
...
We replaced Hypothesis~\ref{hypothesis:strips-mapping} with Theorems~\ref{thm:h-strips-mapping} and \ref{thm:v-strips-mapping}, they are proved in Appendix~C. % \ref{appendix:strips-mapping-theorems}
