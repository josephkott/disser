...
\chapter*{{\normalfont Appendix A} \\ Lemma on Bounded Solutions}
\addcontentsline{toc}{chapter}{Appendix A \quad Lemma on Bounded Solutions}
...
\chapter*{{\normalfont Appendix B} \\ Solutions of the Duffing Equations}
\addcontentsline{toc}{chapter}{Appendix B \quad Solutions of the Duffing Equations}
\label{appendix:solutions-of-duffing-equations}

\section*{B.1 The Equation with Positive Nonlinearity}
\addcontentsline{toc}{section}{B.1 \quad The Equation with Positive Nonlinearity}
...
\section*{B.2 The Equation with Negative Nonlinearity}
\addcontentsline{toc}{section}{B.2 \quad The Equation with Negative Nonlinearity}
...
In white areas the solutions are
\begin{equation}
...
\chapter*{{\normalfont Appendix C} \\ Strip Mapping Theorems}
\addcontentsline{toc}{chapter}{Appendix C \quad Strip Mapping Theorems}
