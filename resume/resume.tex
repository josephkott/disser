...
\textbf{Постановка проблемы.} % \textbf{Введение.}

\textbf{Степень разработанности темы исследования.} % Выделить четко?
...
% Add two of my papers and one conference not on thesis topic as external refs here.
